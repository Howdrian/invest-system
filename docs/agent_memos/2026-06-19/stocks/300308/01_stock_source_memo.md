...
## 搜到什么
- 主张：symbol=300308；数据：symbol=300308；name=中际旭创；source=governed_results summary；来源：governed_results.json#300308；推论：当前公开 Pages 只有最终 governed 摘要；原始逐 Agent transcript 尚未完全持久化。
