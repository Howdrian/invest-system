# Macro Review — 2026-06-02

- Status: `REFRESHED`
- Confidence: `LOW_TO_MEDIUM`
- Prediction market: `degraded`
- Boundary: review-only; no trade execution; no scoring gate bypass.

## 主结论

宏观中性，等待价格和证据共振；VIX neutral: 16.18
...
| `risk_appetite` | `available` | `neutral` | VIX neutral: 16.18 |
...
- `prediction_market_optional_missing_or_degraded`
