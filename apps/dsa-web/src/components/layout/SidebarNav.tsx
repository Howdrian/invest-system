...
import { BarChart3, Bell, BriefcaseBusiness, FileText, Home, LogOut, MessageSquareQuote, Settings2 } from 'lucide-react';
...
const NAV_ITEMS: NavItem[] = [
  ...
  { key: 'reports', label: '报告', to: '/reports', icon: FileText },
